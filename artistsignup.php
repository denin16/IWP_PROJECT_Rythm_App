<?php
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        $sql_query_1 = "SELECT username FROM music_corporation WHERE username = '$email'";
        ...
        if(mysqli_num_rows($check_account) > 0){
            ...
            //defining sql query
            $sql_query = "INSERT INTO music_corporation (name,username,password,type)
            ...
            $sql_query_2 = "SELECT id ,username, password FROM music_corporation";
            ...
            <div class="col-lg-6">
                <div class="text-left form-container">
                    ...
                    <div class="form-heading">
                        <nav class="nav">
                         <a class="nav-link" href="Artistsignup.php" style="color: #222222;">SignUp as Artist</a>
                          <span style="border: 1px solid #333333;"></span>
                          <a class="nav-link text-muted" href="artistsignup.php" style="color: #222222;">SignUp as Streamer</a>
                          <span style="border: 1px solid #333333;"></span>
                    ...
                    <br>
                    <!-- form -->
                    <form onsubmit="return nameCheck() && emailCheck() && passwordCheck() && confirmPasswordCheck();" action="artistsignup.php" method="post">
                        ...
                        <div class="form-group">
                          <select name="type" class="form-control">
                            <option value="individual">Independent Artist</option>
                            <option value="music corporation">Music Corporation</option>
                          </select>
                        </div>
